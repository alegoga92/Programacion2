...
conjuntos_frecuentes1 = fpgrowth(df, min_support=0.01, use_colnames=True)
conjuntos_frecuentes1
...
reglas = association_rules (conjuntos_frecuentes1, metric="confidence", min_threshold=0.01)
...
#print(reglas_ordenadas.columns)
